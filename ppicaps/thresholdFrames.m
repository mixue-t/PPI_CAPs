...
% function [PPIframes, thresholdedIx, task4frames] = thresholdFrames(thisSubject, pilot, seed, percent)
function [taskLabels] = thresholdFrames(thisSubject, pilot, seed, percent)

% inputs: 
% thisSubject: 
% seed (string): name of seed (first letter in Caps)
% percent (int): percentage of frames to be kept
% ----------------------
% Variables' set up
% ----------------------
